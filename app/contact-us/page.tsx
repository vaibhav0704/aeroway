    ...
    <div className="w-full py-16 px-4 md:px-10 lg:px-20 lg:py-40">
      <div className="max-w-5xl mx-auto text-center">
        <motion.h1
          ...
          className="text-5xl mb-4 bg-linear-to-r from-orange-800 via-orange-500 to-orange-100 text-transparent bg-clip-text"
        >
          Contact Us
        </motion.h1>
        <motion.p
      ...
      >
        <h3 className="text-4xl mb-4 bg-linear-to-r from-orange-600 via-orange-400 to-orange-100 text-transparent bg-clip-text text-center">
          Drop Us a Line
        </h3>
