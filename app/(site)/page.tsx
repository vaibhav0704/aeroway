...
export default function Home() {
  return (
    <div className="flex flex-col p-6 md:p-10 xl:px-20 min-h-screen max-w-[100vw]  items-center justify-center bg-[#f9fbff] pt-8 xl:max-w-[4xl] xl:pt-40 text-justify gap-20 font-sans dark:bg-black">
      <Text />
      <section>
        <div>
          <h4
