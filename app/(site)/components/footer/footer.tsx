    ...
    <footer className="w-full relative bottom-0 p-10 lg:p-20 text-[#4e658a] font-bold opacity-75">
      <div className="max-w-7xl bg-[#e8edf5] border-2 border-[#c2d4ee] rounded-4xl mx-auto px-6 py-10 lg:p-20 grid grid-cols-1 md:grid-cols-[1.5fr_1fr_1fr_1fr] gap-10">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-sm">
            <li>
              <Link href="/" className="no-underline transition-transform duration-300 hover:scale-105">
                Home
              </Link>
            </li>
            <li>
              <Link href="/publications" className="no-underline transition-transform duration-300 hover:scale-105">
                Publications
              </Link>
            </li>
            <li>
              <Link href="/about-us" className="no-underline transition-transform duration-300 hover:scale-105">
                About Us
              </Link>
            </li>
            <li>
              <Link href="/contact-us" className="no-underline transition-transform duration-300 hover:scale-105">
                Contact Us
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-sm">
            <li>
              <Link href="/privacy-policy" className="no-underline transition-transform duration-300 hover:scale-105">
                Privacy Policy
              </Link>
            </li>
            <li>
              <Link href="/terms-of-use" className="no-underline transition-transform duration-300 hover:scale-105">
                Terms Of Use
              </Link>
            </li>
            <li>
              <Link href="/information-policy" className="no-underline transition-transform duration-300 hover:scale-105">
                Information Policy
              </Link>
            </li>
          </ul>
      ...
      <div className="w-full border-[#c2d4ee] border-t-2 mt-10">
        <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm">Ⓒ 2025 DO IT FOR ME LLC. All Rights Reserved.</p>
