      ...
      {loading ? (
        ...
        <>
          <div className="grid xl:max-w-4xl grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            {magazine.slice(0, visibleCount).map((item, index) => (
              <motion.div
          ...
          {visibleCount < magazine.length && (
            <div className="text-center mt-10">
              <button
                onClick={loadMoreMagazines}
                className="px-3 py-1 text-sm  bg-linear-to-r
                   from-orange-600 to-yellow-400 rounded-md text-white 
